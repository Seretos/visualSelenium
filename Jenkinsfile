node {
    ...
    stage('Results'){
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'build/coverage', reportFiles: 'index.html,css/bootstrap.min.css', reportName: 'code coverage'])
    }
}